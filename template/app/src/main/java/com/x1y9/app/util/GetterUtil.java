...
public class GetterUtil {
	...
	public static List<Map> getListMap(Object value) {
    ...
    public static <T> T getIfAbsentPut(Map map, String key, T defaultValue) {
		if (map.get(key) == null && defaultValue != null) {
	...
	public static boolean equal(Object left, Object right, boolean canNull) {
		if (left == null || right == null) {
			return canNull && left == null && right == null;
		}
		else if (left == right) {
			return true;
		}
